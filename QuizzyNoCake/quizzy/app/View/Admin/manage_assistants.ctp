...
$(function() {
	...
	<table style="width: 50%; border: 1px solid gray;">
		<tr><th colspan="3" style="text-align: center;">Manage Assistants [<?php echo $researchInfo['Research']['researchName']; ?>]:</th></tr>
		<tr><th style="text-align: center;">Research Assistants:</th><th style="text-align: center;"></th><th style="text-align: center;">Additional Assistants:</th></tr>
		<tr>
			<td>
